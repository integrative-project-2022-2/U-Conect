      ...
      <section className={styles.info_and_button_section}>
        <section className={styles.info_section}>
          <section className={styles.nombre_monitoria_section}>
            <p>{nombre_monitoria}</p>
          </section>
          <section className={styles.info_monitoria_section}>
            <p>
              {" "}
              <b>Vista:</b> {info[0].view_activity}{" "}
            </p>
            <p>
              {" "}
              <b>Nombre:</b> {info[0].activity_name}{" "}
            </p>
            <p>
              {" "}
              <b>Tipo de asesoría:</b> {info[0].type}{" "}
            </p>
            <p>
              {" "}
              <b>Fecha:</b> {info[0].date_activity}{" "}
            </p>
            <p>
              {" "}
              <b>Hora:</b> {info[0].end_hour}{" "}
            </p>
            <p>
              {" "}
              <b>Responsable:</b> {info[0].manager}{" "}
            </p>
            <p>
              {" "}
              <b>Medio:</b> {info[0].means}{" "}
            </p>
            <p>
              {" "}
              <b>Descripción:</b> {info[0].description}{" "}
            </p>
          </section>
        </section>
        <section
          onClick={delete_participant}
          className={styles.button_salir_section}
        >
          <input
            type="button"
            id="button_get_out_advisory"
            className={styles.button_salir}
            value="SALIR DE LA ASESORIA"
          />
        </section>
      </section>
          ...
          <ParticipantList value={participants}>
            {participants.map((participant) => (
              <ParticipantItem
                ...
                text={participant.idparticipant}
              />
            ))}
          </ParticipantList>
        }
